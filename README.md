...
```
[monitoring]
OK       = send_nsca "%(event): [OK] %(message)"
CRITICAL = send_nsca "%(event): [CRITICAL] %(message)"
WARNING  = send_nsca "%(event): [WARNING] %(message)"
DEBUG    = send_nsca "%(event): [DEBUG] %(message)"
UNKNOWN  = send_nsca "%(event): [UNKNOWN] %(message)"
```
